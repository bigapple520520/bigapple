...
public class URLHttpsClient {
	...
	public String get(String url, RequestParams requestParams)
		...
		try {
			...
			result = new StringResultHandler().handleResult(connection, null,
					encode);
		} catch (IOException e) {
	...
	// //////////////////////////////////////////下载部分//////////////////////////////////////////////////////////////
	public void download(String url, String target, ResultCallBack callBack)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public File download(String url, String target, ResultCallBack callBack,
		...
		try {
			...
			result = new FileResultHandler().handleResult(connection, callBack,
					target, isResume);
		} catch (IOException e) {
	...
	public String post(String url, RequestParams requestParams)
		...
		try {
			...
			connection.setRequestProperty("Content-Type",
					"application/x-www-form-urlencoded");// 默认post普通参数

			// 对参数编码放入请求体内
			UrlEncodedFormEntity urlEncodedFormEntity = new UrlEncodedFormEntity(
					requestParams, encode);
			urlEncodedFormEntity.writeTo(new BufferedOutputStream(connection
					.getOutputStream()));
		...
		try {
			...
			connection.setRequestProperty(
					...
					"multipart/form-data; boundary="
							+ multipartEntity.getBoundary());
			multipartEntity.writeTo(new BufferedOutputStream(connection
					.getOutputStream()));
