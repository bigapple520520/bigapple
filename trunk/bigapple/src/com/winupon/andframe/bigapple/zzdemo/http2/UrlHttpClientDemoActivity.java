...
public class UrlHttpClientDemoActivity extends AnActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PreferenceModel.instance(getApplication()).saveSystemProperties("xuan",
				getPackageName() + "eeeee", Types.STRING);
			...
			public void onClick(View v) {
				new CompatibleAsyncTask<Object, Long, String>() {
					...
					protected String doInBackground(Object... params) {
						...
						try {
							// 要上传的文件地址
							String filePath11 = Environment
									.getExternalStorageDirectory().getPath()
									+ "/bigappletest/11.jpg";

							String filePath22 = Environment
									.getExternalStorageDirectory().getPath()
									+ "/bigappletest/22.jpg";

							String filePath33 = Environment
									.getExternalStorageDirectory().getPath()
									+ "/bigappletest/33.jpg";
							...
							ret = client
									.upload("http://blog.xuanner.com/test/testUpload.php",
											requestParams);
						} catch (Exception e) {
							LogUtils.e("", e);
							ret = "请求出错啦！";
					...
					protected String doInBackground(Object... params) {
						...
						try {
							filePath = Environment
									...
									+ "/bigappletest/33.jpg";
							client.download(
									"http://img2.pcpop.com/ArticleImages/0x0/0/118/000118652.jpg",
									filePath, new ResultCallBack() {
										@Override
				...
				new CompatibleAsyncTask<Object, Object, String>() {
					...
					protected String doInBackground(Object... params) {
						...
						try {
							...
							ret = client
									.post("http://blog.xuanner.com/test/testPost.php",
											requestParams);
						} catch (Exception e) {
							LogUtils.e("", e);
							ret = "请求出错啦！";
				...
				new CompatibleAsyncTask<Object, Object, String>() {
					...
					protected String doInBackground(Object... params) {
						...
						try {
							...
							ret = client.get(
									"http://blog.xuanner.com/test/testGet.php",
									requestParams);
						} catch (Exception e) {
							LogUtils.e("", e);
							ret = e.getMessage();
