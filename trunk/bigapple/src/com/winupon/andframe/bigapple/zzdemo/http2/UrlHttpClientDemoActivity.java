 ...
 * $Id$
 */
package com.winupon.andframe.bigapple.zzdemo.http2;
...
public class UrlHttpClientDemoActivity extends AnActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PreferenceModel.instance(getApplication()).saveSystemProperties("xuan", getPackageName() + "eeeee",
                Types.STRING);
                ...
                new CompatibleAsyncTask<Object, Long, String>() {
                    ...
                    protected String doInBackground(Object... params) {
                        ...
                        try {
                            ...
                            ret = client.upload("http://blog.xuanner.com/test/testUpload.php", requestParams);
                        }
                        catch (Exception e) {
                            LogUtils.e("", e);
                            ret = "请求出错啦！";
            ...
            public void onClick(View v) {
                new CompatibleAsyncTask<Object, Long, String>() {
                    ...
                    protected String doInBackground(Object... params) {
                        ...
                        try {
                            filePath = Environment.getExternalStorageDirectory().getPath() + "/bigappletest/33.jpg";
                ...
                new CompatibleAsyncTask<Object, Object, String>() {
                    ...
                    protected String doInBackground(Object... params) {
                        ...
                        try {
                            ...
                            ret = client.post("http://blog.xuanner.com/test/testPost.php", requestParams);
                        }
                        catch (Exception e) {
                            LogUtils.e("", e);
                            ret = "请求出错啦！";
                ...
                new CompatibleAsyncTask<Object, Object, String>() {
                    ...
                    protected String doInBackground(Object... params) {
                        ...
                        try {
                            ...
                            ret = client.get("http://blog.xuanner.com/test/testGet.php", requestParams);
                        }
                        catch (Exception e) {
                            LogUtils.e("", e);
                            ret = e.getMessage();
