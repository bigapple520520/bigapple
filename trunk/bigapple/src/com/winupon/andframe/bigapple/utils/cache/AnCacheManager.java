...
public abstract class AnCacheManager {
	...
	public static LruCache<String, Object> getDefalutObjectCache() {
		if (null == defalutObjectCache) {
			defalutObjectCache = new LruCache<String, Object>(
	...
	public static LruCache<String, Bitmap> getDefalutBitmapCache() {
		if (null == defalutBitmapCache) {
			defalutBitmapCache = new LruCache<String, Bitmap>(
	...
	public static void clear() {
		...
		for (Entry<String, LruCache<String, Object>> entry : objectCachePool
				.entrySet()) {
			entry.getValue().evictAll();
		}

		for (Entry<String, LruCache<String, Bitmap>> entry : bitmapCachePool
				.entrySet()) {
			entry.getValue().evictAll();
		}
	}
