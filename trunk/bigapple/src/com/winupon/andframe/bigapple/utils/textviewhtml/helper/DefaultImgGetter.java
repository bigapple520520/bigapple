/* 
 * @(#)DefaultImgGetter.java    Created on 2013-10-18
 ...
 */
public class DefaultImgGetter implements ImageGetter {
    ...
    public DefaultImgGetter() {
    }

    public DefaultImgGetter(int fromType) {
        this.fromType = fromType;
    }

    public DefaultImgGetter(Context context) {
        this.context = context;
    }

    public DefaultImgGetter(Context context, int fromType) {
        this.context = context;
        this.fromType = fromType;
    }
        ...
        try {
            if (null != createDrawableCallback) {
                ...
                case FROM_TYPE_RESID:
                    drawable = context.getResources().getDrawable(Integer.valueOf(source));
                    break;
                }
