...
public class FileEntityHandler {
     ...
     * @throws IOException
     */
    public File handleEntity(HttpURLConnection connection, EntityCallBack callback, String target, boolean isResume)
            throws IOException {
        ...
        while (!stop && current < count && ((readLen = in.read(buffer, 0, BUFFER_SIZE)) > 0)) {
