...
public class DiskBasedCache implements Cache {
    ...
    /**
     * Constructs an instance of the DiskBasedCache at the specified directory using the default maximum cache size of
     * 5MB.
     * 
     * @param rootDirectory
     *            The root directory of the cache.
    ...
    /*
     * Homebrewed simple serialization system used for reading and writing cache headers on disk. Once upon a time, this
     * used the standard Java Object{Input,Output}Stream, but the default implementation relies heavily on reflection
     * (even for standard types) and generates a ton of garbage.
     */
