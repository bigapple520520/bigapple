...
public class VolleyLog {
    ...
    /**
     * Customize the log tag for your application, so that other apps using Volley don't mix their logs with yours. <br />
    ...
    /**
     * A simple event log with records containing a name, thread ID, and timestamp.<br>
     * 一个简单的事件日志，记录事件名称、线程ID、时间戳
     */
    static class MarkerLog {
        ...
        /**
         * Closes the log, dumping it to logcat if the time difference between the first and last markers is greater
         * than {@link #MIN_DURATION_FOR_LOGGING_MS}.
         * 
         * @param header
